...
// Mangakas
CREATE (:Mangaka{name: "Makoto Yukimura", image:"https://otakuteca.com/images/people/5ff89f9437bda.jpg"})
        -[:CREATES]->
        (:Comic{
                is_active: 1,
        ...
        (:Magazine{name:"Afternoon"})

CREATE (:Mangaka{name: "Eiichiro Oda", image:"https://otakuteca.com/images/people/5b34c8a4bf97e.jpg"})
        -[:CREATES]->
        (:Comic{
                is_active: 1,
        ...
        (:Magazine{name:"Weekly Shōnen Jump"})

CREATE (:Mangaka{name: "Kōhei Horikoshi", image:"https://otakuteca.com/images/people/5d6c3bc322d2c.jpg"})
        -[:CREATES]->
        (:Comic{
                is_active: 1,
...
CREATE (:Mangaka{name: "Inio Asano", image:"https://otakuteca.com/images/people/5d6dfa6e8f590.jpg"})
        -[:CREATES]->
        (:Comic{
                is_active: 0,
        ...
        (:Magazine{name:"Big Comic Spirits"})

CREATE (:Mangaka{name: "Kaito"})
        -[:CREATES]->
        (:Comic{
                is_active: 0,
        ...
        (:Magazine{name:"Shounen Jump+"})

CREATE (:Mangaka{name: "Hajime Isayama", image:"https://otakuteca.com/images/people/5b2178b225df0.jpg"})
        -[:CREATES]->
        (:Comic{
                is_active: 0,
        ...
        (:Magazine{name:"Bessatsu Shonen Magazine"})

CREATE (:Mangaka{name: "Hirohiko Araki", image:"https://otakuteca.com/images/people/5e92d6ba3e1ea.jpg"})
        -[:CREATES]->
        (:Comic{
                is_active: 1,
...
CREATE (:Mangaka{name: "Shinichi Sakamoto", image:"https://otakuteca.com/images/people/5b691012e8dbf.jpg"})
        -[:CREATES]->
        (:Comic{
                is_active: 0,
                ...
                name:"Innocent"})
        -[::PUBLISHED_IN {publish_date: date("1986-09-02")}]->
        (:Magazine{name:"Shuukan Young Jump"})

CREATE (:Mangaka{name: "Chika Umino", image:"https://otakuteca.com/images/people/5f6f5da92d70d.jpg"})
        -[:CREATES]->
        (:Comic{
                is_active: 1,
        ...
        (:Magazine{name:"Young Animal"})

CREATE (:Mangaka{name: "Gege Akutami", image:"https://otakuteca.com/images/people/604673b6e6e3a.jpg"})
        -[:CREATES]->
        (:Comic{
                is_active: 1,
...
CREATE (:Mangaka{name: "Yoshitoki Oima", image:"https://otakuteca.com/images/people/5c6c2fd990341.jpg"})
        -[:CREATES]->
        (:Comic{
                is_active: 1,
        ...
        (:Magazine{name:"Weekly Shōnen Magazine"})

CREATE (oneComic:Mangaka{name: "One", image:"https://otakuteca.com/images/people/5cdb2c8f7972c.jpg"})
        -[:CREATES]->
        (:Comic{
                is_active: 0,
        ...
        (:Magazine{name:"Ura Sunday"})

MERGE (oneComic)-[:CREATES]-> (:Comic{
                is_active: 1,
            ...
            (:Magazine{name:"Tonari no Young Jump (Shueisha)"})

CREATE (:Mangaka{name: "Sui Ishida", image:"https://otakuteca.com/images/people/60467530e5fcd.jpg"})
        -[:CREATES]->
        (:Comic{
                is_active: 0,
        ...
        (:Magazine{name:"Weekly Young Jump"})


CREATE (:Mangaka{name: "Akihito Tukushi", image:"https://otakuteca.com/images/people/5c0ff671874e0.jpg"})
        -[:CREATES]->
        (:Comic{
                is_active: 1,
